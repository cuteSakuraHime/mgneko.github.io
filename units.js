	...
	function init(state = 0){
		...
		cnButton = document.getElementById('cn-button');
		...
		cnButton.onclick = function(){
			if (country != "cn"){
				country = "cn";
				cnButton.classList.remove("btn--primary");
				cnButton.classList.add('btn--checked');
		...
		jpButton.onclick = function(){
			if (country != "jp"){
				...
				cnButton.classList.remove("btn--checked");
				cnButton.classList.add('btn--primary');
				init(1);
			}
		};
